...
export const Logo: React.FC<LogoProps> = ({ className, variant = 'default', logoUrl }) => {
    ...
    const textColor = variant === 'light' ? '#FDFCFB' : '#272F31'; // Gunmetal for default text
    const fiftyOneColor = variant === 'light' ? '#FFFFFF' : '#F64D00'; // Orange for 51
        ...
        >
            <defs>
                <linearGradient id="chili-gradient-new" x1="50%" y1="0%" x2="50%" y2="100%">
                    <stop offset="0%" stopColor="#FFB40B" /> {/* Yellow */}
                    <stop offset="100%" stopColor="#F64D00" /> {/* Orange */}
                </linearGradient>
            </defs>

            {/* Stylized Chili Pepper Icon */}
            <g transform="translate(0, 3)">
                <path d="M38.8,3.2c-6.8-4.3-16.8,1.9-19.3,8.7c-0.2,0.6-0.4,1.2-0.5,1.8c3.9-3.4,8.8-5.4,14-5.7C36.3,7.7,38.8,3.2,38.8,3.2z" fill="#014325" /> {/* Green Leaf */}
