        ...
        <div className="fixed inset-0 bg-black bg-opacity-60 flex justify-center items-center z-[100] p-4 printable-modal" onClick={onClose}>
            <div className="bg-surface dark:bg-zinc-800 rounded-lg shadow-xl w-full max-w-sm" onClick={e => e.stopPropagation()}>
                <div className="p-6 text-sm text-text-primary dark:text-zinc-200 printable-modal-content">
                    ...
                    <p className="text-center text-xs mt-6 text-text-secondary dark:text-zinc-500">Este no es un comprobante de pago.</p>
                </div>
                 <div className="p-4 bg-background dark:bg-zinc-900/50 rounded-b-lg grid grid-cols-2 gap-4 no-print">
                    <button onClick={onClose} className="w-full bg-text-primary/10 dark:bg-zinc-700 hover:bg-text-primary/20 dark:hover:bg-zinc-600 text-text-primary dark:text-zinc-200 font-bold py-2 px-4 rounded-lg">
                        Cerrar
                    </button>
